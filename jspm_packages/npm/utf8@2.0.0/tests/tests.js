...
(function(process) {
  ...
  (function(root) {
    ...
    var QUnit = (function() {
      ...
      return root.QUnit || (root.addEventListener || (root.addEventListener = noop), root.setTimeout || (root.setTimeout = noop), root.QUnit = load('../node_modules/qunitjs/qunit/qunit.js') || root.QUnit, (load('../node_modules/qunit-clib/qunit-clib.js') || {'runInContext': noop}).runInContext(root), addEventListener === noop && delete root.addEventListener, root.QUnit);
    }());
    ...
    if (runExtendedTests) {
      data = data.concat(require("./data.json!systemjs-json"));
    }
